  ...
  return (
    <footer className="bg-navy-800 text-white mt-auto">
      <div className="max-w-7xl mx-auto px-4 md:px-10 py-10 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          <h3 className="text-gold-400 font-bold text-lg mb-3">کالالند۲۴</h3>
          <p className="text-gray-300 text-sm leading-relaxed">
            لوازم برقی و خانگی کالالند۲۴ — فروش خرده و عمده با بهترین قیمت
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="text-gray-300 text-xs mt-4">
            روبیکا: <a href="https://rubika.ir/kalaland24" target="_blank" rel="noopener noreferrer" dir="ltr" className="text-purple-300 font-medium hover:text-purple-200 transition-colors">@kalaland24</a>
          </p>
        </div>
      </div>
