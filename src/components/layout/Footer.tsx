    ...
    <footer className="bg-navy-800 text-white mt-auto">
      <div className="max-w-7xl mx-auto px-10 py-6 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p className="text-gray-300 text-sm">+98 993 464 2455</p>
          <p className="text-gray-300 text-sm mt-1">+98 913 144 4021</p>
        ...
        <div>
          ...
          <div className="flex gap-4 mt-2">
            ...
            <a
              ...
              className="flex items-center justify-center w-10 h-10 rounded-full bg-white/10 hover:bg-pink-500/80 transition-colors"
            >
